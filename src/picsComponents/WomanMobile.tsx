...
const SvgWomanMobile = (props: SVGProps<SVGSVGElement>) => (
  <svg
    className="woman-mobile"
  ...
  >
    <defs>
      <linearGradient
        id="WomanMobile_svg__linear-gradient"
        x1={1.78}
        y1={537.83}
        x2={1.58}
        y2={537.64}
      ...
      >
        <stop offset={0} stopColor="#7f3500" />
        <stop offset={1} stopColor="#231f20" stopOpacity={0} />
      </linearGradient>
      <linearGradient
        id="WomanMobile_svg__linear-gradient-2"
        x1={1.82}
        y1={531.01}
        x2={1.3}
        y2={530.67}
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0.03} stopColor="#7f3500" />
        <stop offset={1} stopColor="#231f20" stopOpacity={0} />
      </linearGradient>
      <linearGradient
        id="WomanMobile_svg__linear-gradient-3"
        x1={1.33}
        y1={520.5}
        x2={0.74}
        y2={520.06}
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop offset={0} stopColor="#843c09" stopOpacity={0.85} />
        <stop offset={1} stopColor="#231f20" stopOpacity={0} />
      </linearGradient>
      <linearGradient
        id="WomanMobile_svg__linear-gradient-4"
        x1={2.04}
        y1={537.08}
        x2={1.9}
        y2={537.14}
      ...
      >
        ...
        <stop offset={0.99} stopColor="#dc841e" />
      </linearGradient>
      <linearGradient
        id="WomanMobile_svg__linear-gradient-5"
        x1={1.83}
        y1={531.61}
        x2={1.31}
        y2={531.26}
        gradientTransform="matrix(43.54 0 0 -26.33 -26.72 14107.68)"
        xlinkHref="#WomanMobile_svg__linear-gradient-2"
      />
      <style>
        {
          ".WomanMobile_svg__cls-6{fill:#68e1fd}.WomanMobile_svg__cls-8{fill:#999a1c}.WomanMobile_svg__cls-10{fill:#f47b56}.WomanMobile_svg__cls-11{fill:#fff}.WomanMobile_svg__cls-15{fill:#f2f2f2}.WomanMobile_svg__cls-16{fill:#ff8f6f}.WomanMobile_svg__cls-17{fill:#003b94}.WomanMobile_svg__cls-18{fill:#3e2928}"
        }
      </style>
    </defs>
    <g id="WomanMobile_svg__Layer_2" data-name="Layer 2">
      <g id="WomanMobile_svg__Layer_1-2" data-name="Layer 1">
        <g id="WomanMobile_svg__Page-1">
          <g id="WomanMobile_svg__Group-4">
            <g
              id="WomanMobile_svg__mention_isometric-2"
              data-name="mention isometric-2"
            >
              <g
                id="WomanMobile_svg__mention_isometric"
                data-name="mention isometric"
              >
                <path
                  id="WomanMobile_svg__Path"
                ...
                />
                <path
                  id="WomanMobile_svg__Path-2"
                  data-name="Path"
                  d="m124 88.69-21.75 12.41s33.53 20.46 40.39 23.34l12.54-18"
                  style={{
                    fill: "url(#WomanMobile_svg__linear-gradient)",
                    isolation: "isolate",
                    opacity: 0.25,
                  }}
                />
                <path
                  id="WomanMobile_svg__Path-3"
                  data-name="Path"
                  d="m116.5 148.26-21.77-12.39L73 148.29s11.34 6.92 22.18 13.27c6.82-4.87 13.72-9.79 21.32-13.3Z"
                  style={{
                    fill: "url(#WomanMobile_svg__linear-gradient-2)",
                    isolation: "isolate",
                    opacity: 0.25,
                  }}
                />
                <path
                  id="WomanMobile_svg__Path-4"
                  data-name="Path"
                  d="m69.59 71.73-13.81 7.88s1.17 7.22 8 10.11l18.11-11.58"
                  style={{
                    opacity: 0.46,
                    fill: "url(#WomanMobile_svg__linear-gradient-3)",
                    isolation: "isolate",
                  }}
                />
                <ellipse
                  id="WomanMobile_svg__Oval"
                  cx={76.35}
                  cy={73.75}
                  rx={8.33}
                  ry={5.86}
                ...
                />
                <path
                  id="WomanMobile_svg__Path-8"
                  data-name="Path"
                  style={{
                    opacity: 0.32,
                    fill: "url(#WomanMobile_svg__linear-gradient-4)",
                    isolation: "isolate",
                  }}
                  d="m127.17 63.48 43.3 26.01 21.39-12.43-38.22-22.24"
                />
                <path
                  id="WomanMobile_svg__Path-9"
                  data-name="Path"
